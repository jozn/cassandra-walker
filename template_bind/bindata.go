...
func models_typesTplGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "models_types.tpl.go", size: 644, mode: os.FileMode(438), modTime: time.Unix(1536683816, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
